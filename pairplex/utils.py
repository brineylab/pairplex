...
def parse_barcodes(
    ...
    """
    Process a fastq file to extract barcodes, UMIs and TSO sequences.
    ...
    if records:
        ...
        # write to parquet (or CSV if debug)
        df = pl.DataFrame(records)
        output_file = output_directory / f"parsed-barcodes_{output_name}.parquet"
